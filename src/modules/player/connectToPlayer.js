...
//
// usage: provide connectToChannel with a property map,
// then a component
//
// connectToChannel takes up to six properties:
...
export default function connectToChannelFactory(propsMap = {
  id: 'id',
  src: 'src',
  channelId: 'channelId',
  volume: 'volume',
  ...
  return function connectToChannel(Composed) {
    return class PlayerConnection extends Component {
      static contextTypes = {
